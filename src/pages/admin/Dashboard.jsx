          ...
          <div className="px-4 py-5 sm:p-6">
            ...
            <div className="mt-4">
              <div className="flex justify-between">
                ...
                <div className="text-sm font-medium text-gray-900">{stats.totalProviders}</div>
              </div>
              <div className="flex justify-between mt-1">
                <div className="text-sm text-gray-500">Homeowners</div>
                <div className="text-sm font-medium text-gray-900">{stats.totalHomeowners}</div>
              </div>
            </div>
          </div>
        </div>
              ...
              <div className="flex items-center">
                ...
                <div className="ml-5 w-0 flex-1">
                  ...
                  <p className="mt-1 text-sm text-gray-500">
                    Review and approve pending provider verification requests.
                  </p>
                  <div className="mt-3">
                    <button
                      type="button"
            ...
            <div className="px-4 py-5 sm:p-6">
              <div className="flex items-center">
                ...
                <div className="ml-5 w-0 flex-1">
                  ...
                  <p className="mt-1 text-sm text-gray-500">
                    Manage community content, featured projects, and announcements.
                  </p>
                  <div className="mt-3">
                    <button
                      type="button"
