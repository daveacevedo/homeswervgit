            ...
            <div className="pt-10 mx-auto max-w-7xl px-4 sm:pt-12 sm:px-6 md:pt-16 lg:pt-20 lg:px-8 xl:pt-28">
              <div className="sm:text-center lg:text-left">
                <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                  ...
                  <span className="block text-green-600 xl:inline">service business</span>
                </h1>
                <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                  Home Swerv connects service providers with homeowners looking for quality professionals, while providing powerful business management tools.
                </p>
      ...
      <div id="features" className="py-12 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:text-center">
            <h2 className="text-base text-green-600 font-semibold tracking-wide uppercase">Features for Service Providers</h2>
            <p className="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">
              Everything you need to grow your business
            </p>
            <p className="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
              Our platform helps you find new clients, manage your schedule, and streamline your business operations.
            </p>
          </div>
            ...
            <dl className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
              <div className="relative">
                ...
                <dd className="mt-2 ml-16 text-base text-gray-500">
                  Connect with homeowners actively looking for your services in your area, with no cold calling required.
                </dd>
              </div>
              ...
              <div className="relative">
                ...
                <dd className="mt-2 ml-16 text-base text-gray-500">
                  Track all your jobs in one place, from initial quote to final payment, with automated status updates.
                </dd>
              </div>
              ...
              <div className="relative">
                ...
                <dd className="mt-2 ml-16 text-base text-gray-500">
                  Gain insights into your business performance with detailed analytics on jobs, revenue, and customer satisfaction.
                </dd>
              </div>
              ...
              <div className="relative">
                ...
                <dd className="mt-2 ml-16 text-base text-gray-500">
                  Manage your availability and appointments with our integrated calendar system, reducing scheduling conflicts.
                </dd>
              </div>
              ...
              <div className="relative">
                <dt>
                  ...
                  <p className="ml-16 text-lg leading-6 font-medium text-gray-900">Payment Processing</p>
                </dt>
                <dd className="mt-2 ml-16 text-base text-gray-500">
                  Get paid faster with our integrated payment system, including invoicing, payment tracking, and automatic deposits.
                </dd>
              </div>
            </dl>
          </div>
            ...
            <div className="relative lg:ml-10">
              ...
              <blockquote className="relative">
                <div className="text-2xl leading-9 font-medium text-gray-900">
                  <p>
                    "Since joining Home Swerv, my contracting business has grown by 35%. The platform handles client acquisition, scheduling, and payments, allowing me to focus on delivering quality work."
                  </p>
                </div>
                <footer className="mt-8">
                  <div className="flex">
                    ...
                    <div className="ml-4 lg:ml-0">
                      ...
                      <div className="text-base font-medium text-green-600">General Contractor in Austin, TX</div>
                    </div>
                  </div>
                </footer>
              </blockquote>
      ...
      <div className="bg-green-700">
        <div className="max-w-2xl mx-auto text-center py-16 px-4 sm:py-20 sm:px-6 lg:px-8">
          ...
          <p className="mt-4 text-lg leading-6 text-green-200">
            Join thousands of service providers already using Home Swerv to grow their business.
          </p>
          <Link
            to="/register"
