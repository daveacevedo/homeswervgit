        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-4">
              <li>
                <Link to="/features/homeowners" className="text-base text-gray-300 hover:text-white">
                  Features
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/features/testimonials" className="text-base text-gray-300 hover:text-white">
                  Testimonials
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-4">
              <li>
                <Link to="/features/providers" className="text-base text-gray-300 hover:text-white">
                  Features
                </Link>
              </li>
              <li>
