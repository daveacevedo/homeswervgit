...
const Footer = () => {
  const navigation = {
    ...
    features: [
      { name: 'For Homeowners', href: '/features/homeowners' },
      { name: 'For Service Providers', href: '/features/providers' },
      { name: 'Pricing', href: '/features/pricing' },
      { name: 'Testimonials', href: '/features/testimonials' },
    ],
    legal: [
      { name: 'Privacy', href: '#' },
      { name: 'Terms', href: '#' },
      ...
      <div className="max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
        <nav className="-mx-5 -my-2 flex flex-wrap justify-center" aria-label="Footer">
          <div className="px-5 py-2">
            <h3 className="text-sm font-semibold text-gray-500 tracking-wider uppercase">Main</h3>
