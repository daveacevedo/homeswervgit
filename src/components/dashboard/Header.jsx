...
// Import from our custom icons file instead of directly from @heroicons/react
import { BellIcon } from '../../components/icons/HeroIcons'
...
function Header({ toggleSidebar, userType }) {
  ...
  // Determine which profile to use based on userType
  const profile = userType === 'provider' ? providerProfile : homeownerProfile
  ...
  return (
    <div className="relative z-10 flex-shrink-0 flex h-16 bg-white shadow">
      ...
      >
        ...
        {/* Replace MenuIcon with inline SVG */}
        <svg
            ...
            <div>
              <Menu.Button className="max-w-xs bg-white flex items-center text-sm rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500">
                ...
                <div className="h-8 w-8 rounded-full bg-primary-600 flex items-center justify-center text-white font-bold">
                  {userType === 'provider' && providerProfile?.business_name 
                    ? providerProfile.business_name.charAt(0) 
                    : userType === 'homeowner' && homeownerProfile?.first_name 
                      ? homeownerProfile.first_name.charAt(0) 
