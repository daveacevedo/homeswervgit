/*
  # Trust Features Tables

  1. New Tables
    - `provider_verifications` - Stores verification documents and status for providers
    - `reviews` - Stores customer reviews and provider responses
    - `guarantees` - Stores satisfaction guarantee claims
    - `transactions` - Stores payment transactions
    - `escrow_payments` - Stores escrow payment details
