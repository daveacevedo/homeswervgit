/*
  # Fix vision board items table

  1. Changes
    - Drop the existing vision_board_items table if it exists
    - Recreate the vision_board_items table with proper columns
...
DROP TABLE IF EXISTS vision_board_items;
